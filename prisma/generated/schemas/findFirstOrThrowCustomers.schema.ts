...
export const CustomersFindFirstOrThrowSchema: z.ZodType<Prisma.CustomersFindFirstOrThrowArgs> = z.object({ select: CustomersFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CustomersIncludeObjectSchema.optional()), orderBy: z.union([CustomersOrderByWithRelationInputObjectSchema, CustomersOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomersWhereInputObjectSchema.optional(), cursor: CustomersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomersScalarFieldEnumSchema, CustomersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CustomersFindFirstOrThrowArgs>;

export const CustomersFindFirstOrThrowZodSchema = z.object({ select: CustomersFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CustomersIncludeObjectSchema.optional()), orderBy: z.union([CustomersOrderByWithRelationInputObjectSchema, CustomersOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomersWhereInputObjectSchema.optional(), cursor: CustomersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomersScalarFieldEnumSchema, CustomersScalarFieldEnumSchema.array()]).optional() }).strict();