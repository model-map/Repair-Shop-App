...
export const CustomersFindFirstSchema: z.ZodType<Prisma.CustomersFindFirstArgs> = z.object({ select: CustomersFindFirstSelectSchema.optional(), include: z.lazy(() => CustomersIncludeObjectSchema.optional()), orderBy: z.union([CustomersOrderByWithRelationInputObjectSchema, CustomersOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomersWhereInputObjectSchema.optional(), cursor: CustomersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomersScalarFieldEnumSchema, CustomersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CustomersFindFirstArgs>;

export const CustomersFindFirstZodSchema = z.object({ select: CustomersFindFirstSelectSchema.optional(), include: z.lazy(() => CustomersIncludeObjectSchema.optional()), orderBy: z.union([CustomersOrderByWithRelationInputObjectSchema, CustomersOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomersWhereInputObjectSchema.optional(), cursor: CustomersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomersScalarFieldEnumSchema, CustomersScalarFieldEnumSchema.array()]).optional() }).strict();